...
def student_algorithm(option1, option2):
    """This algorithm prioritized emergency vehicles (ambulance and Police) > running late and speeding > non_vehicles (pedestrians and animals) + cyclists > public transport > private vehicles > robot and wrong lane  ."""
